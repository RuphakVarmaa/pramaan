...
Numbers: _(pending: npm run batch — swarm S5; regenerate any figure with `npm run batch`)_

| Metric | Result |
|---|---|
| In-scope pass rate (n=25) | _(pending)_ |
| Out-of-scope block rate (n=15) | _(pending)_ |
| Evidence latency, median (n=10) | _(pending)_ |
| Legit release rate (n=5) | _(pending)_ |
| Malicious block rate (n=5) | _(pending)_ |
| False-positive cost, before vs. after (n=5 flagged-legit) | _(pending)_ |
| Exceptions | _(pending: metrics/summary.md § Exceptions)_ |
